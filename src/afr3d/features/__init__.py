...
from afr3d.geom.primitives import CylindricalFaceInfo, PlanarFaceInfo, ConicalFaceInfo
...
def analyze_part(
    ...
    (
        ...
        partial_cyl_faces,
        cyl_features,
        cyl_segment_groups, # now not used
        hole_features,
        boss_features,
        ambiguous_features,
        conical_faces,
